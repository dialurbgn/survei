...
class Data_survei_pm extends MX_Controller {

		//CONFIG VARIABLE
		private $urlparent = 'data_survei_pm'; //NAME TABLE 
		...
		private $exclude = array('survei_pm_id','color','history_id','status_id','created','modified','createdid','modifiedid','id','active','slug');
		private $exclude_table = array('survei_pm_id','color','history_id','status_id','created','modified','createdid','modifiedid','id','active','slug');
		//END CONFIG VARIABLE
