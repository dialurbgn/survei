...
class Master_lop_field_required_tipe extends MX_Controller {

		//CONFIG VARIABLE
		private $urlparent = 'master_lop_field_required_tipe'; //NAME TABLE 
		...
		private $exclude = array('color','history_id','status_last_id','status_id','status_last_id','created','modified','createdid','modifiedid','id','active','slug');
		private $exclude_table = array('color','history_id','status_last_id','status_id','status_last_id','created','modified','createdid','modifiedid','id','active','slug');
		//END CONFIG VARIABLE
