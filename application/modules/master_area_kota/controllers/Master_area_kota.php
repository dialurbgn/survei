...
class Master_area_kota extends MX_Controller {

		//CONFIG VARIABLE
		private $urlparent = 'master_area_kota'; //NAME TABLE 
		...
		private $exclude = array('sort','path','color','history_id','status_id','created','modified','createdid','modifiedid','id','active','slug');
		private $exclude_table = array('sort','path','color','history_id','status_id','created','modified','createdid','modifiedid','id','active','slug');
		//END CONFIG VARIABLE
