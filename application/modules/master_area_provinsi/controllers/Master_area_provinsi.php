...
class Master_area_provinsi extends MX_Controller {

		//CONFIG VARIABLE
		private $urlparent = 'master_area_provinsi'; //NAME TABLE 
		...
		private $exclude = array('user_id_fin','user_id','color','history_id','status_id','created','modified','createdid','modifiedid','id','active','slug');
		private $exclude_table = array('user_id_fin','color','history_id','status_id','created','modified','createdid','modifiedid','id','active','slug');
		//END CONFIG VARIABLE
