<div id="kt_content_container" class="app-container  container-fluid  d-flex flex-column-fluid align-items-start container-xxl">
 <!--begin::Post-->
               ...
               <script type="text/javascript">
                 ...
                 <?php
                      if (isset($_GET["message"])) {
					   ...
					   updateCsrfToken(data.csrf_hash)function deletedata(id) {
