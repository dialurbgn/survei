             ...
             <div class="card-header tabbable" style="padding:0;display:none" id="ul_menu_header">
               <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold" role="tablist" style="margin:0;margin-left:30px">
                 <li class="nav-item mt-2" id="nav-1" onClick="get_data(1,'nav-1');">
				  ...
				  <li class="nav-item mt-2" id="nav-3" onClick="get_data(3,'nav-3');">
                   <a class="nav-link " data-toggle="tab" href="javascript:;" role="tab">
                     <i class="far fa-list-alt"></i> &nbsp;Banned </a>
                 </li>
				  <li class="nav-item mt-2" id="nav-4" onClick="get_data(4,'nav-4');">
                   <a class="nav-link " data-toggle="tab" href="javascript:;" role="tab">
                     <i class="far fa-list-alt"></i> &nbsp;Need Validate </a>
                 </li>
				  <li class="nav-item mt-2" id="nav-6" onClick="get_data(6,'nav-6');">
                   <a class="nav-link " data-toggle="tab" href="javascript:;" role="tab">
                     <i class="far fa-list-alt"></i> &nbsp;Need Validate Admin</a>
                 </li>
				  <li class="nav-item mt-2" id="nav-5" onClick="get_data(5,'nav-5');">
                   <a class="nav-link active" data-toggle="tab" href="javascript:;" role="tab">
                     <i class="far fa-list-alt"></i> &nbsp;Online </a>
                 </li>
				 ...
				 <?php
				  ...
				  function restorebanneddata(id){
							...
							var boxdelete = bootbox.confirm({
								...
								callback: function (result) {
									if(result==true){
											$.post('<?php echo base_url($headurl.'/restorebanneddata'); ?>',{ id : id, <?php echo $this->security->get_csrf_token_name(); ?> : csrfHash  }, function (data) {
												updateCsrfToken(data.csrf_hash)
												if(data.message == "success"){
													table.draw();
													boxdelete.modal('hide'); 
						...
						function validatedata(id){
							...
							var boxdelete = bootbox.confirm({
								...
								callback: function (result) {
									if(result==true){
											$.post('<?php echo base_url($headurl.'/validatedata'); ?>',{ id : id, <?php echo $this->security->get_csrf_token_name(); ?> : csrfHash  }, function (data) {
												updateCsrfToken(data.csrf_hash)
												if(data.message == "success"){
													table.draw();
													boxdelete.modal('hide'); 
						...
						function validatedataadmin(id){
							...
							var boxdelete = bootbox.confirm({
								...
								callback: function (result) {
									if(result==true){
											$.post('<?php echo base_url($headurl.'/validatedataadmin'); ?>',{ id : id, <?php echo $this->security->get_csrf_token_name(); ?> : csrfHash  }, function (data) {
												updateCsrfToken(data.csrf_hash)
												if(data.message == "success"){
													table.draw();
													boxdelete.modal('hide'); 
						...
						function banneddata(id){
							...
							var boxdelete = bootbox.confirm({
								...
								callback: function (result) {
									if(result==true){
											$.post('<?php echo base_url($headurl.'/banneddata'); ?>',{ id : id, <?php echo $this->security->get_csrf_token_name(); ?> : csrfHash  }, function (data) {
												updateCsrfToken(data.csrf_hash)
												if(data.message == "success"){
													table.draw();
													boxdelete.modal('hide'); 
