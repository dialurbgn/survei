...
<?php
	...
	$modulenya = $this->ortyd->select2_getname($iddata,$module,'id','module');
	if($modulenya == '-'){
		$modulenya = null;
	}
?>
				...
				<div class="card-body">
					...
					<?php
						if($query_column){
							...
							<?php }elseif($rows_column['name'] == 'module'){ ?>
									...
									<div id="<?php echo $rows_column['name'].'_header'; ?>" draggable="true" class="drag-item col-lg-<?php echo $width_column; ?> py-3">
										<div class="form-group">
											<div class="row">
												...
												<div class="col-lg-9">
													<input id="<?php echo $rows_column['name']; ?>" type="text" name="<?php echo $rows_column['name']; ?>" class="form-control form-control-sm" value="<?php echo $modulenya; ?>"<?php if($rows_column['is_nullable'] == 'NO'){echo ' required ';} ?> <?php echo $disable; ?> placeholder="<?php echo 'Input '.$label_name_text; ?>" />
												</div>
											</div>
										</div>
									</div>
