...
class Master_unit extends MX_Controller {

		//CONFIG VARIABLE
		private $urlparent = 'master_unit'; //NAME TABLE 
		...
		private $exclude = array('is_sbu','color','history_id','status_id','created','modified','createdid','modifiedid','id','active','slug');
		private $exclude_table = array('is_sbu','color','history_id','status_id','created','modified','createdid','modifiedid','id','active','slug');
		//END CONFIG VARIABLE
