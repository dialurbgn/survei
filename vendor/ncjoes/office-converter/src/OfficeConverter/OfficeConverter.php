...
class OfficeConverter
{
     ...
     */
    public function __construct($filename, $tempPath = null, $bin = 'libreoffice', $prefixExecWithExportHome = true, $logPath = '')
    {
    ...
    protected function makeCommand($outputDirectory, $outputExtension)
    {
        ...
        $userInstallationDirectoryOption = "-env:UserInstallation=file://{$_SERVER['DOCUMENT_ROOT']}/.config/libreoffice-profile{$randomNumber}";
